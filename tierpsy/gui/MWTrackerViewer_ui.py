...
class Ui_MWTrackerViewer(object):
    def setupUi(self, MWTrackerViewer):
        ...
        MWTrackerViewer.resize(1140, 810)
        ...
        self.gridLayout.addWidget(self.imageSlider, 0, 2, 1, 7)
        ...
        self.gridLayout.addWidget(self.pushButton_U, 1, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_WS, 1, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_save, 1, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_video, 3, 2, 1, 7)
        ...
        self.gridLayout.addWidget(self.lineEdit_skel, 4, 2, 1, 7)
        ...
        self.comboBox_h5path.addItem("")
        self.gridLayout.addWidget(self.comboBox_h5path, 5, 2, 1, 7)
