...
summarizer_valid_options = {
    ...
    'select_feat' : ['all', 'tierpsy_level_0', 'tierpsy_level_1', 'tierpsy_level_2', 'tierpsy_level_3','tierpsy_level_4','tierpsy_8', 'tierpsy_16', 'tierpsy_256', 'tierpsy_2k','select_by_keywords'],
